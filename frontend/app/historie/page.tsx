    ...
    <div className="bg-slate-50 min-h-screen py-12">
      <div className="max-w-[95rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          <h1 className="text-4xl md:text-6xl font-black text-slate-700 tracking-tight">
            Historie Klubu
          </h1>
        </div>
          ...
          <div className="bg-white rounded-3xl shadow-sm p-5 sm:p-8 md:p-16 border border-slate-100 mx-0 md:mx-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 md:gap-y-12">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-700 leading-relaxed text-sm md:text-base">
                  Příprava na video-natáčení zápasů a přenosy na TV COM. U B mužstva nastupují noví trenéři J. Chadima a J. Chládek. Smutnou událostí bylo úmrtí trenéra A mužstva Karel Ševčík. Rozhodnutí o zvětšení základny mládeže a rekonstrukce kabin (topení, WC).
                </p>
              </div>
